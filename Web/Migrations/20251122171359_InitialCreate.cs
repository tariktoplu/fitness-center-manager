        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxSessionsPerMonth = table.Column<int>(type: "integer", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    GymBranchId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GymWorkingHours_GymBranches_GymBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GymServices_GymBranches_GymBranchId",
                        column: x => x.GymBranchId,
                        principalTable: "GymBranches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputImageUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Recommendation = table.Column<string>(type: "text", nullable: true),
                    GeneratedImageUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyFatPercentage = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    BMI = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false, computedColumnSql: "\"Weight\" / ((\"Height\" / 100.0) * (\"Height\" / 100.0))", stored: true),
                    ChestCm = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    WaistCm = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    HipsCm = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    ArmCm = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    ThighCm = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    BodyType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_MembershipPlans_Date", "\"EndDate\" >= \"StartDate\"");
                    table.ForeignKey(
                        name: "FK_MembershipPlans_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_TrainerAvail_Time", "\"EndTime\" > \"StartTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Appointments_Time", "\"EndTime\" > \"StartTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymServices_GymBranchId_ServiceId",
                table: "GymServices",
                columns: new[] { "GymBranchId", "ServiceId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymWorkingHours_GymBranchId_DayOfWeek",
                table: "GymWorkingHours",
                columns: new[] { "GymBranchId", "DayOfWeek" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipPlans_MemberId",
